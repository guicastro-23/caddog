    ...
    public function index(Request $request)
{
    ...
    return view('admin.cardapio.index', ['itemCardapio' => $itemCardapio, 'sort' => $sort, 'direction' => $direction, 'categorias' => $categorias]);
}
    ...
    public function create()
    {
        ...
        return view('admin.cardapio.create', compact('categorias'));
    }
    ...
    public function store(ItemCardapioRequest $request)
{
    ...
    return redirect()->route('admin.cardapio.index')->with('success', 'Item criado com sucesso.');
}
    ...
    public function product(ItemCardapio $itemCardapio)
    {
        ...
        return view('admin.cardapio.product', [
...
public function delete(ItemCardapio $itemCardapio)
{
    ...
    return view('admin.cardapio.delete', ['itemCardapio' => $itemCardapio]);
}
...
public function destroy(ItemCardapio $itemCardapio)
{
    ...
    return redirect()->route('admin.cardapio.index')->with('success', 'Item deletado com sucesso.');
}
...
public function update(Request $request, ItemCardapio $itemCardapio)
{
    ...
    return redirect()->route('admin.cardapio.index')->with('success', 'Item atualizado com sucesso.');
}
...
public function edit(ItemCardapio $itemCardapio)
{
    ...
    return view('admin.cardapio.edit', compact('itemCardapio', 'categorias')); // Pass item and categories to the view
}

public function show(ItemCardapio $itemCardapio)
{
    return view('admin.cardapio.show', compact('itemCardapio'));
}

...
<div class="section container">
    <div class="header-container">
        ...
        <div class="class button-group"><a href="<?php echo e(route('admin.adicionais.index')); ?>" class="btn-small waves-effect waves-light grey inline">Voltar</a>
        </div>
    </div>
    <hr>
    ...
    <div class="section container">
        <form action="<?php echo e(route('admin.adicionais.store')); ?>" method="POST" class="form-container">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\guilh\best_imoveis\resources\views/admin/adicionais/create.blade.php ENDPATH**/ ?>
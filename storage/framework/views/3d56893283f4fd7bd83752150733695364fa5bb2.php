...
} elseif ($_instance->childHasBeenRendered('F4Vjqok')) {
    $componentId = $_instance->getRenderedChildComponentId('F4Vjqok');
    $componentTag = $_instance->getRenderedChildComponentTagName('F4Vjqok');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('F4Vjqok');
} else {
    $response = \Livewire\Livewire::mount('carrinho-total', []);
    $html = $response->html();
    $_instance->logRenderedChild('F4Vjqok', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

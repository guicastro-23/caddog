<div>
    <footer class="footer-container" style="position: fixed; bottom: 0; left: 0; width: 100%; background-color: #F5F5F5; border-top: 1px solid #ddd; padding: 10px 0;
     text-align: center; display: flex; justify-content: center; align-items: center; z-index: 10;">
        <form action="<?php echo e(route('carrinho.avancar')); ?>" method="POST" style="width: 100%; max-width: 800px; padding: 0 10px;">
            <?php echo csrf_field(); ?>
            <button type="submit" class="btn waves-effect waves-light green btn-responsive"
                ...
                <?php if(empty(session()->get('pedido'))): ?> disabled <?php endif; ?>>
                <span style="font-size: 1.2em; margin: 0;">Avançar</span>
                <span style="font-size: 1.2em; margin: 0;">R$ <?php echo e(number_format($total, 2, ',', '.')); ?></span>
            </button>
        </form>
    </footer>
</div>
...
<?php /**PATH C:\Users\guilh\best_imoveis\resources\views/livewire/carrinho-total.blade.php ENDPATH**/ ?>
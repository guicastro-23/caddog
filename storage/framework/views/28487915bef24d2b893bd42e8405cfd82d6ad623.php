    ...
    <div class="section container">
        ...
        <div class="header-container">
            ...
            <div class="class button-group">
                ...
                <a href="<?php echo e(route('admin.categorias.create')); ?>" class="btn-small waves-effect waves-light green inline">Adicionar</a>
            </div>
        ...
        <div class="table-container">
            <table class="striped">
                <thead>
                    <tr>
                        <th>
                            <a href="<?php echo e(route('admin.categorias.index', ['sort' => 'nome', 'direction' => $direction === 'asc' ? 'desc' : 'asc'])); ?>" class="header-link">
                                Nome
                                <?php if($sort === 'nome'): ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('admin.categorias.show', $categoria->id)); ?>" class="btn blue btn-small">
                                    <i class="material-icons">remove_red_eye</i>
                                </a>
                                <a href="<?php echo e(route('admin.categorias.edit', $categoria->id)); ?>" class="btn green btn-small">
                                    <i class="material-icons">edit</i>
                                </a>
                                <button class="btn red btn-small modal-trigger" data-target="deleteModal"
                                        data-url="<?php echo e(route('admin.categorias.destroy', $categoria->id)); ?>"
                                        data-name="<?php echo e($categoria->nome); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\guilh\best_imoveis\resources\views/admin/categorias/index.blade.php ENDPATH**/ ?>
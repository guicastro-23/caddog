...
<div class="section container">
    <div class="header-container">
        ...
        <a href="<?php echo e(route('admin.cardapio.create')); ?>" class="btn-small waves-effect waves-light green inline">Adicionar</a>
        </div>
    ...
    <div class="table-container">
        <table class="striped">
            <thead>
                <tr>
                    <th>
                        <a href="<?php echo e(route('admin.cardapio.index', ['sort' => 'nome', 'direction' => $direction === 'asc' ? 'desc' : 'asc'])); ?>" class="header-link">
                            Nome
                            <?php if($sort === 'nome'): ?>
                    ...
                    <th>
                        <a href="<?php echo e(route('admin.cardapio.index', ['sort' => 'categoria_id', 'direction' => $direction === 'asc' ? 'desc' : 'asc'])); ?>" class="header-link">
                            Categoria
                    ...
                    <th>
                        <a href="<?php echo e(route('admin.cardapio.index', ['sort' => 'preco', 'direction' => $direction === 'asc' ? 'desc' : 'asc'])); ?>" class="header-link">
                            Preço
                            <?php if($sort === 'preco'): ?>
                                <i class="material-icons"><?php echo e($direction === 'asc' ? 'arrow_drop_up' : 'arrow_drop_down'); ?></i>
                            <?php endif; ?>
            ...
            <tbody>
                <?php $__currentLoopData = $itemCardapio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('admin.cardapio.show', $item->id)); ?>" class="btn blue btn-small">
                                <i class="material-icons">remove_red_eye</i>
                            </a>
                            <a href="<?php echo e(route('admin.cardapio.edit', $item->id)); ?>" class="btn green btn-small">
                                <i class="material-icons">edit</i>
                            </a>
                            <button class="btn red btn-small modal-trigger" data-target="deleteModal"
                                    data-url="<?php echo e(route('admin.cardapio.destroy', $item->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\guilh\best_imoveis\resources\views/admin/cardapio/index.blade.php ENDPATH**/ ?>